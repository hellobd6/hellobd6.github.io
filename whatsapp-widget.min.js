var GBWAWidget = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    // const WIDGET_MINIMIZED_WIDTH = 192;
    var WIDGET_MINIMIZED_HEIGHT = 62;
    var WIDGET_MARGIN = 4;
    var WIDGET_MARGIN_XY = 12;
    var config = {};
    var widget;
    var iframe;
    var hookQueue = [];
    ...
    var updateWidgetStyle = function (isOpened) {
        var _a, _b, _c;
        ...
        if (isOpened) {
            ...
            iframe.style.bottom = WIDGET_MARGIN_XY + "px";
        }
        else {
            iframe.style.left = "auto";
            // iframe.style.width = `${WIDGET_MARGIN + WIDGET_MINIMIZED_WIDTH + WIDGET_MARGIN}px`;
            iframe.style.width = "fit-content";
            iframe.style.height = WIDGET_MARGIN + WIDGET_MINIMIZED_HEIGHT + WIDGET_MARGIN + "px";
            iframe.style.bottom = ((_c = (_b = (_a = config === null || config === void 0 ? void 0 : config.options) === null || _a === void 0 ? void 0 : _a.widgetMargin) === null || _b === void 0 ? void 0 : _b.marginY) !== null && _c !== void 0 ? _c : WIDGET_MARGIN_XY) + "px";
        }
    };
    var createWidget = function (url) {
        ...
        widget.style.zIndex = (_b = (_a = config === null || config === void 0 ? void 0 : config.options) === null || _a === void 0 ? void 0 : _a.widgetZIndex) !== null && _b !== void 0 ? _b : "2147483647";
        widget.dataset.state = "closed";
        iframe = document.createElement("iframe");
        iframe.id = "gb-waw-iframe";
        iframe.allowTransparency = "true";
        iframe.src = url;
        iframe.setAttribute("style", "border: none; display: block; position: fixed; top: auto; visibility: visible; max-width: 100vw; transition: all 0.3s ease-in-out, width 0ms; background: none transparent; opacity: 1; pointer-events: auto; touch-action: auto;");
        // iframe.style.width = `${WIDGET_MARGIN + WIDGET_MINIMIZED_WIDTH + WIDGET_MARGIN}px`;
        iframe.style.width = "fit-content";
        iframe.style.height = WIDGET_MARGIN + WIDGET_MINIMIZED_HEIGHT + WIDGET_MARGIN + "px";
        iframe.style.maxHeight = "100vh";
        iframe.style.bottom = WIDGET_MARGIN_XY + "px";
        if (((_c = config === null || config === void 0 ? void 0 : config.options) === null || _c === void 0 ? void 0 : _c.widgetPosition) === "RIGHT") {
            iframe.style.left = "auto";
            iframe.style.right = ((_f = (_e = (_d = config === null || config === void 0 ? void 0 : config.options) === null || _d === void 0 ? void 0 : _d.widgetMargin) === null || _e === void 0 ? void 0 : _e.marginX) !== null && _f !== void 0 ? _f : WIDGET_MARGIN_XY) + "px";
        }
        else {
            iframe.style.left = ((_j = (_h = (_g = config === null || config === void 0 ? void 0 : config.options) === null || _g === void 0 ? void 0 : _g.widgetMargin) === null || _h === void 0 ? void 0 : _h.marginX) !== null && _j !== void 0 ? _j : WIDGET_MARGIN_XY) + "px";
            iframe.style.right = "auto";
        }
        iframe.style.zIndex = (_l = (_k = config === null || config === void 0 ? void 0 : config.options) === null || _k === void 0 ? void 0 : _k.widgetZIndex) !== null && _l !== void 0 ? _l : "2147483647";
    ...
    var init = function (c) {
        ...
        createWidget(iframeUrl);
        attachMessageListener();
        if ((_a = options === null || options === void 0 ? void 0 : options.analytics) !== null && _a !== void 0 ? _a : true) {
